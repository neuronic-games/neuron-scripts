...
#
# Enable by setting email_setting.mail_log_folder to a folder path; leave
...
def log_sent(to_addr, attachment_size=None, success=True, error=None):
    ...
    email_setting.mail_log_folder is set.
    ...
    """
    folder = getattr(email_setting, "mail_log_folder", "")
    if not folder:
        return
