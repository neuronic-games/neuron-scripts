...
def checkUpdateStatus():
    extract_dir = audit_setting.appEXEPath.rsplit('/', 2)[0] + "/"
    archive_info_file = audit_setting.appEXEPath.rsplit('/', 2)[0] + "/archive.txt"
    version_cur_file = audit_setting.appEXEPath.rsplit('/', 2)[0] + "/version.txt"
